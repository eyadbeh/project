...
if (isset($_POST["submit"])) {
  ...
  $result = mysqli_query($conn, "SELECT * FROM user_login WHERE username = '$usernameemail' OR email = '$usernameemail'");
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" action="" method="post">
                                        ...
                                        <div class="pt-1 mb-4 d-grid gap-2">
                                            <button type="submit" class="btn btn-info btn-lg btn-block" name="submit">Login</button>
                                        </div>

                                        <p>Don't have an account? <a href="regist.php" class="link-info fw-bolder text-decoration-none">Register here</a></p>
